...
badd +1 ../Itch/Itch41.py
badd +1 Fix42.py
badd +1 ../Itch/Itch41Tests.py
...
exe 'vert 2resize ' . ((&columns * 94 + 96) / 193)
exe '3resize ' . ((&lines * 12 + 22) / 45)
exe 'vert 3resize ' . ((&columns * 98 + 96) / 193)
exe '4resize ' . ((&lines * 29 + 22) / 45)
exe 'vert 4resize ' . ((&columns * 98 + 96) / 193)
argglobal
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 110 - ((10 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
110
